...
Pal_SSCyc2:	incbin	"Palettes\Cycle - Special Stage 2.bin"
		...
		include	"Includes\Object Names.asm"
		...
		include	"Includes\LoadPerZone.asm"
		include	"ZoneDefs.asm"
		include	"Includes\LoadPerCharacter.asm"
		include	"CharacterDefs.asm"
		include	"Includes\LoadPerDemo.asm"
